...
public class AuthorModel implements Serializable {
    ...
    public AuthorModel(Long id, int author_id, String author_name, String author_nickname, String author_account, String author_github, String author_csdn, String author_websit, String author_introduction) {
        this.id = id;
    ...
    public String toString() {
        return "AuthorModel{" + "author_account='" + author_account + '\'' + ", author_id=" + author_id + ", author_name='" + author_name + '\'' + ", author_nickname='" + author_nickname + '\'' + ", author_github='" + author_github + '\'' + ", author_csdn='" + author_csdn + '\'' + ", author_websit='" + author_websit + '\'' + ", author_introduction='" + author_introduction + '\'' + '}';
    }
