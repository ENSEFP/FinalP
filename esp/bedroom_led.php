<?php 
require "conn.php";
$bedroom_led = $_GET["bedroom_led"];


$sql = "UPDATE smarthome_basic SET bedroom_led='$bedroom_led' WHERE id=0";
...
<html>
    ...
    <table class="greenTable">
        <th>Currently the bedroom light is: </th>
        <tr>
            <td id="2" class="bedroom_led"> 
                <?php 
                    if ($bedroom_led == 1){
                        echo "ON";
                    } 
	...
	<script type="text/javascript">
		$(document).ready(function(){
            if ("<?php echo $bedroom_led_change; ?>" !=""){
				...
				$.get("http://192.168.4.1/esp/bedroom_led.php/?pin=" + p + "&action=" + action); // execute get request
